...
var app = {
    ...
    getSymbolData: function getSymbolData(req, res) {
            ...
            request(data.url, function (error, response, body) {
                ...
                if (!error && response.statusCode == 200) {
                    ...
                    */
                    ...
                    _symbol2.default.insertOne(options, resData, function (result) {
        ...
        exType(ex).then(function (data) {

            if (data.ex === "huobi") {
                //- - huobi
                return huobiApiData(data);
            } else if (data.ex === "okex") {
                //- - okex
                return okexApiData(data);
            } else if (data.ex === "gate") {
                //- - gate
                return gateApiData(data);
            } else if (data.ex === "binance") {
                //- -binance
    ...
    pushSymbolData: function pushSymbolData(req, res) {
        //api -(存储在数据库的交易所交易对列表的实时数据 - 推送到前端 - - pass)
...
module.exports = app;
//# sourceMappingURL=symbolController.js.map